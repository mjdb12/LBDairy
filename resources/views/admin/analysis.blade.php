...
<script>
    ...
    function exportCSV() {
        ...
        const headers = ['Farmer ID', 'Name', 'Email', 'Phone', 'Location', 'Status', 'Registration Date'];
        ...
        link.setAttribute('download', `Admin_FarmersAnalysisReport_${downloadCounter}.csv`);
    ...
    function exportPDF() {
        try {
            ...
            const headers = ['Farmer ID', 'Name', 'Farm Name', 'Barangay', 'Livestock Count', 'Production Score', 'Status'];
            ...
            tableData.forEach(row => {
                const rowData = [
                    ...
                    row[2] || '', // Farm Name
                    row[3] || '', // Barangay
                    row[4] || '', // Livestock Count
                    row[5] || '',  // Production Score
                    row[6] || ''   // Status
                ];
    ...
    function exportPNG() {
        ...
        html2canvas(tempTable, {
            ...
            const link = document.createElement('a');
            link.download = `Admin_FarmersAnalysisReport_${downloadCounter}.png`;
