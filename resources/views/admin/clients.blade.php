...
function printTable() {
    try {
        const tableData = clientsTable && clientsTable.data ? clientsTable.data().toArray() : [];
        ...
        let printContent = `
            <div style="font-family: Arial, sans-serif; margin: 20px;">
                <div style="text-align: center; margin-bottom: 20px;">
                    <h1 style="color: #18375d; margin-bottom: 5px;">Clients Directory Report</h1>
                    <p style="color: #666; margin: 0;">Generated on: ${new Date().toLocaleDateString()}</p>
                </div>
                <table border="1" style="border-collapse: collapse; width: 100%; border: 1px solid #000;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #000; padding: 8px; background-color: #f2f2f2; text-align: left;">Client ID</th>
                            <th style="border: 1px solid #000; padding: 8px; background-color: #f2f2f2; text-align: left;">Name</th>
                            <th style="border: 1px solid #000; padding: 8px; background-color: #f2f2f2; text-align: left;">Address</th>
                            <th style="border: 1px solid #000; padding: 8px; background-color: #f2f2f2; text-align: left;">Contact</th>
        ...
        if (typeof window.printElement === 'function') {
            ...
            window.openPrintWindow(printContent, 'Clients Directory Report');
        } else {
            window.print();
        }
    } catch (e) {
