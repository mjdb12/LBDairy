...
function printProductivity() {
    try {
        ...
        let html = `
            <div style=\"font-family: Arial, sans-serif; margin: 20px;\">
                <div style=\"text-align: center; margin-bottom: 20px;\">
                    <h1 style=\"color:#18375d; margin-bottom:5px;\">Sales Report</h1>
        ...
        else if (typeof window.openPrintWindow === 'function') { window.openPrintWindow(html, 'Sales Report'); }
    ...
    } catch (e) { console.error('printProductivity error:', e); try { $('#' + 'salesTable').DataTable().button('.buttons-print').trigger(); } catch(_){} }
}
