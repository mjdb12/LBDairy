...
function printProductionTable() {
    try {
        ...
        else if (typeof window.openPrintWindow === 'function') { window.openPrintWindow(html, 'Production Report'); }
    ...
    } catch(e){ console.error('printProductionTable error:', e); try { $('#' + 'productionTable').DataTable().button('.buttons-print').trigger(); } catch(_){} }
}
