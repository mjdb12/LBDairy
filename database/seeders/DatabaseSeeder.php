...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create farmer users (idempotent)
        ...
        // Create additional farmer users (idempotent)
        ...
        // Create farms (idempotent)
        $farm1 = Farm::firstOrCreate(
            ['name' => 'Green Valley Farm', 'owner_id' => $farmer1->id],
            [
        ...
        $farm2 = Farm::firstOrCreate(
            ['name' => 'Sunset Ranch', 'owner_id' => $farmer2->id],
            [
        ...
        // Create livestock (idempotent via tag_number)
        $livestock1 = Livestock::firstOrCreate(
            ['tag_number' => 'LS001'],
            [
                'name' => 'Bessie',
                'farm_id' => $farm1->id,
        ...
        $livestock2 = Livestock::firstOrCreate(
            ['tag_number' => 'LS002'],
            [
                'name' => 'Daisy',
                'farm_id' => $farm1->id,
        ...
        $livestock3 = Livestock::firstOrCreate(
            ['tag_number' => 'LS003'],
            [
                'name' => 'Molly',
                'farm_id' => $farm2->id,
        ...
        // Create sample production records (idempotent by livestock and date)
        ...
        // Create some recent users for testing notifications (idempotent)
        User::firstOrCreate(
        ...
        // Ensure there is at least one farmer, farm, livestock, and sample data for local setups
        $this->call(EnsureLocalFarmerSeeder::class);
